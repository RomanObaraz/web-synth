export const knobMap = {
    ...
    lpf: {
        cutoff: { cc: 77, min: 20, max: 20000, default: 20000, center: 1000 },
        resonance: { cc: 93, min: 0, max: 20, default: 2 },
    ...
    reverb: {
        mix: { cc: 16, min: 0, max: 100, default: 0 },
    },
    distortion: {
        drive: { cc: 17, min: 0, max: 100, default: 0 },
        mix: { cc: 91, min: 0, max: 100, default: 0 },
    },
    bitcrusher: {
        bitDepth: { cc: 79, min: 2, max: 16, default: 16 },
        sampleRate: { cc: 72, min: 200, max: 44100, default: 44100, center: 4000 },
    },
    lfo: {
        rate: { cc: 73, min: 0, max: 20, default: 2 },
        depth: {
            cc: 75,
            vibrato: { cc: 75, min: 0, max: 100, default: 5 },
            tremolo: { cc: 75, min: 0, max: 100, default: 50 },
            wah: { cc: 75, min: 0, max: 5000, default: 100, center: 500 },
            pwm: { cc: 75, min: 0, max: 100, default: 40 },
        },
    },
};
