export const knobMap = {
    ...
    ampEnvelope: {
        attack: { cc: null, min: 0, max: 10, default: 0 },
        decay: { cc: null, min: 0, max: 10, default: 0 },
        sustain: { cc: null, min: 0, max: 100, default: 100 },
        release: { cc: null, min: 0, max: 10, default: 0.1 },
    },
    lpf: {
        cutoff: { cc: 16, min: 20, max: 20000, default: 20000 },
    ...
    lfo: {
        ...
        depth: {
            ...
            wah: { cc: 72, min: 0, max: 5000, default: 100 },
